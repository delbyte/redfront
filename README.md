...
### Go to https://redfront-phi.vercel.app to use!

### OR, Zero-Installation Setup (if you want to setup the repo locally)
```bash
...
- **Network**: Works great on 2G, and optimized for 3G/4G/5G
- **Storage**: < 500kB for the entire application
...
Built by [delbyte](https://github.com/delbyte) for the Web Warriors hackathon.
